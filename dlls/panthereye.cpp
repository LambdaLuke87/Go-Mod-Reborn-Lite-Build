...
{
public:
	void Spawn() override;		// initialisation
	...
	CBaseEntity* KickNormal();
	CBaseEntity* KickLow();
	CBaseEntity* KickHigh();
	void Jump();
...
CBaseEntity* CDiablo::KickNormal()
{
	TraceResult tr;
