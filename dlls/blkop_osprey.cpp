...
TYPEDESCRIPTION CBlackOpsOsprey::m_SaveData[] =
	{
		DEFINE_FIELD(CBlackOpsOsprey, m_pGoalEnt, FIELD_CLASSPTR),
		DEFINE_FIELD(CBlackOpsOsprey, m_vel1, FIELD_VECTOR),
		DEFINE_FIELD(CBlackOpsOsprey, m_vel2, FIELD_VECTOR),
		DEFINE_FIELD(CBlackOpsOsprey, m_pos1, FIELD_POSITION_VECTOR),
		DEFINE_FIELD(CBlackOpsOsprey, m_pos2, FIELD_POSITION_VECTOR),
		DEFINE_FIELD(CBlackOpsOsprey, m_ang1, FIELD_VECTOR),
		DEFINE_FIELD(CBlackOpsOsprey, m_ang2, FIELD_VECTOR),

		DEFINE_FIELD(CBlackOpsOsprey, m_startTime, FIELD_TIME),
		DEFINE_FIELD(CBlackOpsOsprey, m_dTime, FIELD_FLOAT),
		DEFINE_FIELD(CBlackOpsOsprey, m_velocity, FIELD_VECTOR),

		DEFINE_FIELD(CBlackOpsOsprey, m_flIdealtilt, FIELD_FLOAT),
		DEFINE_FIELD(CBlackOpsOsprey, m_flRotortilt, FIELD_FLOAT),

		DEFINE_FIELD(CBlackOpsOsprey, m_flRightHealth, FIELD_FLOAT),
		DEFINE_FIELD(CBlackOpsOsprey, m_flLeftHealth, FIELD_FLOAT),

		DEFINE_FIELD(CBlackOpsOsprey, m_iUnits, FIELD_INTEGER),
		DEFINE_ARRAY(CBlackOpsOsprey, m_hGrunt, FIELD_EHANDLE, MAX_CARRY),
		DEFINE_ARRAY(CBlackOpsOsprey, m_vecOrigin, FIELD_POSITION_VECTOR, MAX_CARRY),
		DEFINE_ARRAY(CBlackOpsOsprey, m_hRepel, FIELD_EHANDLE, 4),

		// DEFINE_FIELD( CBlackOpsOsprey, m_iSoundState, FIELD_INTEGER ),
		// DEFINE_FIELD( CBlackOpsOsprey, m_iSpriteTexture, FIELD_INTEGER ),
		// DEFINE_FIELD( CBlackOpsOsprey, m_iPitch, FIELD_INTEGER ),

		DEFINE_FIELD(CBlackOpsOsprey, m_iDoLeftSmokePuff, FIELD_INTEGER),
		DEFINE_FIELD(CBlackOpsOsprey, m_iDoRightSmokePuff, FIELD_INTEGER),
};
...
void CBlackOpsOsprey::Spawn()
{
	...
	SetThink(&CBlackOpsOsprey::FindAllThink);
	SetUse(&CBlackOpsOsprey::CommandUse);
...
void CBlackOpsOsprey::FindAllThink()
{
	...
	SetThink(&CBlackOpsOsprey::FlyThink);
	pev->nextthink = gpGlobals->time + 0.1;
...
void CBlackOpsOsprey::DeployThink()
{
	...
	SetThink(&CBlackOpsOsprey::HoverThink);
	pev->nextthink = gpGlobals->time + 0.1;
}
...
CBaseMonster* CBlackOpsOsprey::MakeGrunt(Vector vecSrc)
{
	CBaseEntity* pEntity;
	CBaseMonster* pGrunt;
...
void CBlackOpsOsprey::UpdateGoal()
{
	if (m_pGoalEnt)
	{
		m_pos1 = m_pos2;
...
void CBlackOpsOsprey::HitTouch(CBaseEntity* pOther)
{
...
/*
int CBlackOpsOsprey::TakeDamage( entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int bitsDamageType )
{
	if (m_flRotortilt <= -90)
	{
		m_flRotortilt = 0;
...
void CBlackOpsOsprey::Killed(entvars_t* pevAttacker, int iGib)
{
	ClearShockEffect();
	...
	SetThink(&CBlackOpsOsprey::DyingThink);
	SetTouch(&CBlackOpsOsprey::CrashTouch);
	pev->nextthink = gpGlobals->time + 0.1;
	pev->health = 0;
...
void CBlackOpsOsprey::CrashTouch(CBaseEntity* pOther)
{
