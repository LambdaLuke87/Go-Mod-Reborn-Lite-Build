...
TYPEDESCRIPTION COFBlackOpsApache::m_SaveData[] =
	{
		DEFINE_FIELD(COFBlackOpsApache, m_iRockets, FIELD_INTEGER),
		DEFINE_FIELD(COFBlackOpsApache, m_flForce, FIELD_FLOAT),
		DEFINE_FIELD(COFBlackOpsApache, m_flNextRocket, FIELD_TIME),
		DEFINE_FIELD(COFBlackOpsApache, m_vecTarget, FIELD_VECTOR),
		DEFINE_FIELD(COFBlackOpsApache, m_posTarget, FIELD_POSITION_VECTOR),
		DEFINE_FIELD(COFBlackOpsApache, m_vecDesired, FIELD_VECTOR),
		DEFINE_FIELD(COFBlackOpsApache, m_posDesired, FIELD_POSITION_VECTOR),
		DEFINE_FIELD(COFBlackOpsApache, m_vecGoal, FIELD_VECTOR),
		DEFINE_FIELD(COFBlackOpsApache, m_angGun, FIELD_VECTOR),
		DEFINE_FIELD(COFBlackOpsApache, m_flLastSeen, FIELD_TIME),
		DEFINE_FIELD(COFBlackOpsApache, m_flPrevSeen, FIELD_TIME),
		//	DEFINE_FIELD( COFBlackOpsApache, m_iSoundState, FIELD_INTEGER ),		// Don't save, precached
		//	DEFINE_FIELD( COFBlackOpsApache, m_iSpriteTexture, FIELD_INTEGER ),
		//	DEFINE_FIELD( COFBlackOpsApache, m_iExplode, FIELD_INTEGER ),
		//	DEFINE_FIELD( COFBlackOpsApache, m_iBodyGibs, FIELD_INTEGER ),
		DEFINE_FIELD(COFBlackOpsApache, m_pBeam, FIELD_CLASSPTR),
		DEFINE_FIELD(COFBlackOpsApache, m_flGoalSpeed, FIELD_FLOAT),
		DEFINE_FIELD(COFBlackOpsApache, m_iDoSmokePuff, FIELD_INTEGER),
};
...
void COFBlackOpsApache::Spawn()
{
	...
	{
		SetThink(&COFBlackOpsApache::NullThink);
...
void COFBlackOpsApache::StartupUse(CBaseEntity* pActivator, CBaseEntity* pCaller, USE_TYPE useType, float value)
{
	SetThink(&COFBlackOpsApache::HuntThink);
	SetTouch(&COFBlackOpsApache::FlyTouch);
...
void COFBlackOpsApache::Killed(entvars_t* pevAttacker, int iGib)
{
	ClearShockEffect();
...
void COFBlackOpsApache::FlyTouch(CBaseEntity* pOther)
{
...
void COFBlackOpsApache::CrashTouch(CBaseEntity* pOther)
{
...
void COFBlackOpsApache::FireRocket()
{
	...
	CBaseEntity* pRocket = CBaseEntity::Create("hvr_blkop_rocket", vecSrc, pev->angles, edict());
	if (pRocket)
...
LINK_ENTITY_TO_CLASS(hvr_blkop_rocket, COFBlackOpsApacheHVR);

TYPEDESCRIPTION COFBlackOpsApacheHVR::m_SaveData[] =
	{
		//	DEFINE_FIELD( COFBlackOpsApacheHVR, m_iTrail, FIELD_INTEGER ),	// Dont' save, precache
		DEFINE_FIELD(COFBlackOpsApacheHVR, m_vecForward, FIELD_VECTOR),
};
