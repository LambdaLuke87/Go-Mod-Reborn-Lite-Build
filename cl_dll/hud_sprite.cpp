...
static void ScaledSetCrosshair(HSPRITE hspr, Rect rc, int r, int g, int b)
{
...
void HudSpriteRenderer::SPR_DrawInternal(int frame, float x, float y, float width, float height, const Rect* dimensions, int mode)
{
	if (!sprite_model)
	{
		return;
...
void HudSpriteRenderer::SPR_DrawAdditive(int frame, int x, int y, const Rect* prc)
{
	if (IsCustomScale())
	{
...
void HudSpriteRenderer::SetCrosshair(HSPRITE hspr, Rect rc, int r, int g, int b)
{
	crosshair = hspr;
